package org.lenve.databinding1.ui;
...
import org.lenve.databinding1.util.DateUtil;
...
public class PullToRefreshView extends LinearLayout {
	...
	private void headerPrepareToRefresh(int deltaY) {
		...
		if (newTopMargin >= 0 && mHeaderState != RELEASE_TO_REFRESH) {
			mHeaderTextView.setText(getResources().getString(R.string.pull_to_refresh_release_label));
